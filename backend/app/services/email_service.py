...
<p style="color:#334155;line-height:1.6">You can now log in and start identifying crop diseases.</p>
...
<div style="display:inline-block;background:#ecfdf5;border:2px solid #10b981;border-radius:12px;padding:16px 32px;letter-spacing:8px;font-size:32px;font-weight:800;color:#065f46">{otp}</div>
</div>
